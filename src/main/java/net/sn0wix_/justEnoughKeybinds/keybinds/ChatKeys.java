...
public class ChatKeys extends NotEKKeyBindings {
    public static final String CHAT_KEYS_CATEGORY_KEY = "key.category." + JustEnoughKeybinds.MOD_ID + ".chat_keys";
    public static final ChatKeysCategory CHAT_KEYS_MOD_CATEGORY = new ChatKeysCategory(CHAT_KEYS_CATEGORY_KEY, 1);
    public static final KeyBinding.Category CHAT_KEYS_CATEGORY = KeyBinding.Category.create(JustEnoughKeybinds.getIdentifier(CHAT_KEYS_CATEGORY_KEY));
