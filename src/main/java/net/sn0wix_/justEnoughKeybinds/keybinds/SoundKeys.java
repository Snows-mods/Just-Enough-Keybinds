...
public class SoundKeys extends NotEKKeyBindings {
    public static final String SOUND_KEYS_CATEGORY_KEY = "key.category." + JustEnoughKeybinds.MOD_ID + ".sound";
    public static final KeyBinding.Category SOUND_KEYS_CATEGORY = KeyBinding.Category.create(JustEnoughKeybinds.getIdentifier(SOUND_KEYS_CATEGORY_KEY));
