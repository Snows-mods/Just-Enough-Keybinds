...
public class PresetKeys extends NotEKKeyBindings {
    public static final String PRESET_CATEGORY_KEY = "key.category." + JustEnoughKeybinds.MOD_ID + ".presets";
    public static final KeyBinding.Category PRESET_CATEGORY = KeyBinding.Category.create(JustEnoughKeybinds.getIdentifier(PRESET_CATEGORY_KEY));
            ...
            try {
                if (PresetLoader.getCurrentPreset() == null) {
                    try {
                        ...
                        JustEnoughKeybinds.LOGGER.info("Cannot load the next or previous preset because none exist!");
                    }
