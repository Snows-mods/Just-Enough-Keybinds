...
public class SkinLayersKeys extends NotEKKeyBindings {
    public static final String SKIN_LAYERS_CATEGORY_KEY = "key.category." + JustEnoughKeybinds.MOD_ID + ".skin_layers";
    public static final KeyBinding.Category SKIN_LAYERS_CATEGORY = KeyBinding.Category.create(JustEnoughKeybinds.getIdentifier(SKIN_LAYERS_CATEGORY_KEY));
