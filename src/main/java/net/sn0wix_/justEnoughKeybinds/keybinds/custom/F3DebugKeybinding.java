package net.sn0wix_.justEnoughKeybinds.keybinds.custom;
...
public class F3DebugKeybinding implements INotEKKeybinding, Comparable<F3DebugKeybinding> {
    ...
    public void setBoundKey(InputUtil.Key boundKey) {
        ...
        if (JustEnoughKeybinds.DEBUG_KEYS_CONFIG != null) {
            JustEnoughKeybinds.DEBUG_KEYS_CONFIG.saveBoundKey(getTranslationKey(), boundKey.getTranslationKey());
        }
    }
