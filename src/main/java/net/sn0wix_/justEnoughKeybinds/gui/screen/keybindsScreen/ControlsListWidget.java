...
import net.sn0wix_.justEnoughKeybinds.gui.TexturedButtonWidget;
import net.sn0wix_.justEnoughKeybinds.keybinds.NotEKKeyBindings;
import net.sn0wix_.justEnoughKeybinds.keybinds.custom.F3DebugKeybinding;
    ...
    public class KeyBindingEntry extends ControlsListWidget.Entry {
        ...
        public KeyBindingEntry(INotEKKeybinding binding, Text bindingName) {
            ...
            this.settingsButton = new TexturedButtonWidget(0, 0, 20, 20, Text.empty(), button -> client.setScreen(binding.getSettingsScreen(parent))
                    , Supplier::get, Identifier.of(JustEnoughKeybinds.MOD_ID, "textures/settings.png"), 14, 14, 14, 14);
