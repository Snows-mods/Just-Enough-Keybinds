...
public class ModKeybindsButton extends ControlsListWidget.CategoryEntry {
    ...
    public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, JustEnoughKeybinds.ICON, x + 340 / 2 - MinecraftClient.getInstance().textRenderer.getWidth(button.getMessage()) / 2 - 20, y, 0, 0, 0, 18, 18, 18, 18);
    }
