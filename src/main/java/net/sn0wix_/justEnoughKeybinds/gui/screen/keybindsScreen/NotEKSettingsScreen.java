...
import net.sn0wix_.justEnoughKeybinds.gui.SettingsScreen;
import net.sn0wix_.justEnoughKeybinds.gui.screen.BasicLayoutWidget;
...
public class NotEKSettingsScreen extends SettingsScreen {
    ...
    public NotEKSettingsScreen(Screen parent) {
        super(parent, Text.translatable("settings." + JustEnoughKeybinds.MOD_ID));
