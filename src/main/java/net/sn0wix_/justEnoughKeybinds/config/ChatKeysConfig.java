...
public class ChatKeysConfig {
    public static ConfigClassHandler<ChatKeysConfig> HANDLER = ConfigClassHandler.createBuilder(ChatKeysConfig.class)
            .id(Identifier.of(JustEnoughKeybinds.MOD_ID, "chat_keys"))
            .serializer(config -> GsonConfigSerializerBuilder.create(config)
                    .setPath(FabricLoader.getInstance().getConfigDir().resolve(JustEnoughKeybinds.MOD_ID).resolve("chat_keys.json"))
