...
public class NotEKSettings {
    public static ConfigClassHandler<NotEKSettings> HANDLER = ConfigClassHandler.createBuilder(NotEKSettings.class)
            .id(Identifier.of(JustEnoughKeybinds.MOD_ID, "settings"))
            .serializer(config -> GsonConfigSerializerBuilder.create(config)
                    .setPath(FabricLoader.getInstance().getConfigDir().resolve(JustEnoughKeybinds.MOD_ID).resolve("settings.json"))
